...
<body>
  ...
  <?php
    require_once "./session_checks/check_login.php";
    $user = $_SESSION['username'];
  ?>

  <div class="topnav">
    <a class="active" href="#home">Home</a>
    <a href="prevbook.php">My Bookings</a>
    <a href="bookingpage.php">Get a Ride</a>
    <a href="ratechart.php">Rate Chart</a>
    <label class="username"><?php echo $user; ?></label>
